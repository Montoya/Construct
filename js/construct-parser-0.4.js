...
function parseElement(el){
  ...
  // alert( new String(this.getAttribute('class')).split(" ") ); // classes!
  
  var classes = el.getAttribute('class'); // classes!
...
function parseConstruct(){
  ...
  $('#construct-output pre#construct-markup').empty().append(markup);
  $('#construct-output pre#construct-styles').empty().append(css);
